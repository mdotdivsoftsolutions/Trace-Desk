...
export default function ProjectWorkspacePage({
  ...
  const milestoneStatusColors: Record<string, string> = {
    ...
    completed: 'bg-neutral-100 dark:bg-[#334155] text-neutral-900 dark:text-white border border-neutral-200 dark:border-[#334155] border-emerald-500/20',
    invoiced: 'bg-neutral-100 dark:bg-[#334155] text-neutral-900 dark:text-white border border-neutral-200 dark:border-[#334155] border-purple-500/20 font-bold',
  ...
  const taskPriorityStyles: Record<string, string> = {
    urgent: 'bg-neutral-100 dark:bg-[#334155] text-neutral-900 dark:text-white border border-neutral-200 dark:border-[#334155] border-rose-500/20 font-bold',
    high: 'bg-neutral-100 dark:bg-[#334155] text-neutral-900 dark:text-white border border-neutral-200 dark:border-[#334155] border-amber-500/20',
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-neutral-500 dark:text-neutral-400">
              <span className="flex items-center gap-1 text-neutral-700 dark:text-neutral-300 font-semibold">
                <DollarSign className="w-3.5 h-3.5 text-neutral-700 dark:text-neutral-300" />
      ...
      {activeTab === 'vault' && (
        <div className="space-y-4">
          ...
          {(!project.credentials || project.credentials.length === 0) ? (
            <div className="p-12 rounded-lg border border-dashed border-neutral-300 dark:border-[#2D333F] text-center space-y-3 bg-white/50 dark:bg-[#1C2029]/50">
              <Key className="w-8 h-8 text-neutral-700 dark:text-neutral-300 mx-auto" />
              <h4 className="text-sm font-semibold text-neutral-800 dark:text-neutral-200">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              {copiedKeyIndex === idx ? (
                                <>
                                  <Check className="w-3 h-3 text-neutral-700 dark:text-neutral-300" /> Copied
                                </>
                              ) : (
                                <>
