...
import { useProject, useUpdateProject, useClients } from '@/hooks';
import { UpdateProjectInput, ProjectLinkInput, ProjectCredentialInput } from '@/lib/validations';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-neutral-200 dark:border-[#2A2A2A]">
        <div className="space-y-1">
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-400">
            Update scope specifications, multiple deployment links, credential vault, and delivery timeline.
          </p>
        </div>
