...
export default function SettingsPage() {
  ...
  return (
    <div className="w-full space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      {/* Tabs Navigation */}
      <div className="flex items-center gap-1.5 border-b border-neutral-200 dark:border-[#2D333F] pb-1 overflow-x-auto">
        {tabs.map((tab) => {
          const Icon = tab.icon;
            ...
            <button
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-[#1C2029]'
              )}
            >
      ...
      {isLoading ? (
        <div className="p-6 rounded-lg bg-white dark:bg-[#1C2029] border border-neutral-200 dark:border-[#2D333F] space-y-4 animate-pulse">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {activeTab === 'currency' && (
            <div className="p-6 rounded-lg bg-white dark:bg-[#1C2029] border border-neutral-200 dark:border-[#2D333F] shadow-sm space-y-5">
              ...
              <div className="p-4 rounded-md bg-neutral-50 dark:bg-[#111318] border border-neutral-200 dark:border-[#2D333F] text-xs space-y-1">
                <span className="font-bold text-neutral-800 dark:text-neutral-200">
                  Current Display Example:
                </span>
                <p className="text-neutral-500">
                  Standard Format: <span className="font-bold font-mono text-neutral-900 dark:text-white">{formData.currencySymbol}1,50,000.00</span>
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'bank' && (
            <div className="p-6 rounded-lg bg-white dark:bg-[#1C2029] border border-neutral-200 dark:border-[#2D333F] shadow-sm space-y-5">
              <div className="border-b border-neutral-200 dark:border-[#2D333F] pb-3">
                <h2 className="font-heading text-base font-bold text-neutral-900 dark:text-white flex items-center gap-2">
                  <Landmark className="w-4 h-4 text-neutral-700 dark:text-neutral-300" />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="18"
                      className="w-full px-3.5 py-2 rounded-md bg-neutral-50 dark:bg-[#111318] border border-neutral-300 dark:border-neutral-700 text-xs font-medium text-neutral-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-neutral-400 dark:focus:ring-neutral-500 pr-8"
                    />
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            <button
              type="submit"
              disabled={isSaving}
              className="flex items-center gap-2 px-6 py-2.5 rounded-lg bg-neutral-900 hover:bg-neutral-800 text-white dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-100 active:scale-95 font-bold text-xs shadow-sm transition-all disabled:opacity-50"
            >
              {isSaving ? (
