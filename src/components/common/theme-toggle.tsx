...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative p-2 rounded-md text-neutral-600 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white bg-neutral-100 dark:bg-[#1A1A1A] hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all border border-neutral-200 dark:border-[#2A2A2A] focus:outline-none focus:ring-2 focus:ring-indigo-500"
    ...
    >
      {isDark ? (
        ...
        <Moon className="w-4 h-4 transition-transform text-indigo-600" />
      )}
    </button>
  );
}
