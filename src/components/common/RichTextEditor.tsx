...
export function RichTextEditor({
  ...
  return (
    <div
      className={cn(
        'w-full rounded-lg border bg-neutral-50 dark:bg-[#0B0F19] transition-all overflow-hidden flex flex-col',
        isFocused
    ...
    >
      {/* Formatting Toolbar */}
      <div className="flex flex-wrap items-center gap-0.5 p-1.5 border-b border-neutral-200 dark:border-[#232B3D] bg-white/80 dark:bg-[#131A2A]/80 backdrop-blur-sm text-neutral-600 dark:text-neutral-300">
        <button
          type="button"
          disabled={disabled}
        ...
        <div className="h-4 w-px bg-neutral-200 dark:bg-[#232B3D] mx-1" />
      ...
      <div
        ...
        className={cn(
          ...
          '[&_pre]:bg-neutral-200/60 [&_pre]:dark:bg-[#131A2A] [&_pre]:p-2 [&_pre]:rounded [&_pre]:font-mono [&_pre]:text-[11px] [&_pre]:my-1.5',
