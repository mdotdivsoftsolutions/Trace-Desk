  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" role="dialog" aria-modal="true">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        ...
        <div className="w-screen max-w-md sm:max-w-xl bg-white dark:bg-[#131A2A] border-l border-neutral-200 dark:border-[#232B3D] shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
          {/* Header */}
