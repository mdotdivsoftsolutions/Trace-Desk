...
import { Eye, DollarSign, Receipt, Plus, Download, Loader2, Pencil, Trash2 } from 'lucide-react';
                ...
                <tr key={inv._id} className="hover:bg-neutral-50/80 dark:hover:bg-neutral-800/40 transition-colors">
                  ...
                  <td className="px-5 py-4 text-right">
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      <Link href={`/invoices/${inv._id}/edit`} className="p-1.5 rounded text-neutral-500 hover:text-neutral-900 dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors" title="Edit Invoice">
